...
app.use(function (req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    user = formatCookie(req.headers.cookie).username;
                    return [4, User.findOne({ username: user })
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4, mongoose.connect(process.env.MONGO_URI)];
            case 1:
                _a.sent();
                console.log('You successfully connected to MongoDB!');
                app.listen(process.env.PORT || 3333, function () {
                    console.log("Listening on port ".concat(process.env.PORT || 3333, "."));
                });
                return [3, 3];
            case 2:
                err_1 = _a.sent();
